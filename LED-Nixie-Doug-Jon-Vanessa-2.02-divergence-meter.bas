...
105:
    ...
    if a = 0 and s = 0 and r = 1 then gosub 710 ' its midnight so test for new divergence
...
710:
    r = IO.eeread(18)
    gosub 8020
    if r <> (IO.eeread(18)) then goto 181
    return
'================================================
' SHOW Alarm
' VAR: n, p, s, i
...
8010:
    ...
    if w <> (IO.eeread(18)) then IO.eewrite(18, w) ' 18 = Current birthdate data id
    return
'================================================
...
8050:
    ...
    for i = 1 to 18   ' EEPROM data output
    t = IO.eeread(i)
    print "EEP[";i;"] = ";t
    next i
    return
