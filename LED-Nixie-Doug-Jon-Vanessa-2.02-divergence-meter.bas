...
' Night mode: (seperate colour & brightness settings)
'        if begin and end are the same, Night mode is disabled.
...
' Version
    ...
    LED.iled(2, 60 + read 10, 1)
    LED.iled(2, 70 + read 10, 5)
    LED.show()
    delay 2000
'
' EEPROM INIT
...
205:
    i = (IO.getldr() * 2) + IO.eeread(12) ' measured brightness + minimum overall brightness
...
3665:
    ...
    return
'............................................................
3700: ' cycling through all LEDs 0-79 in increasing colours with random white
    LED.ihsv(9, 0, 0, v)
